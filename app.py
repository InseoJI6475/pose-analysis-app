# app.py (whitenoise 적용 최종 완성본)

from flask import Flask, render_template, request, jsonify
import os
from werkzeug.utils import secure_filename
import analyzer_module
from whitenoise import WhiteNoise # ★★★ 1. 안내 직원(whitenoise) 불러오기 ★★★

app = Flask(__name__)

# ★★★ 2. 안내 직원에게 static 폴더를 담당하도록 일 시키기 ★★★
# 이 코드는 서버 환경(Render)에서 static 폴더를 찾게 해주는 핵심입니다.
